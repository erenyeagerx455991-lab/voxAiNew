...
export function computeProviderAverage(
  ...
  if (n === 0) {
    return {
      ...
      sampleCount: 0,
      evaluator: {
        hero: 0, layout: 0, cta: 0, accessibility: 0, shadcn: 0, consistency: 0, overall: 0,
        visualScore: 0, heroVisual: 0, ctaVisual: 0, layoutVisual: 0, responsiveVisual: 0,
      },
  ...
  return {
    ...
    evaluator: {
      ...
      visualScore:      sum('visualScore',      r => r.evaluatorScores.visualScore      ?? 0),
      heroVisual:       sum('heroVisual',       r => r.evaluatorScores.heroVisual       ?? 0),
      ctaVisual:        sum('ctaVisual',        r => r.evaluatorScores.ctaVisual        ?? 0),
      layoutVisual:     sum('layoutVisual',     r => r.evaluatorScores.layoutVisual     ?? 0),
      responsiveVisual: sum('responsiveVisual', r => r.evaluatorScores.responsiveVisual ?? 0),
    },
    lighthouse: {
...
export function computeQualityDelta(
  ...
  return {
    ...
    evaluator: {
      ...
      visualScore:      round2(ev.visualScore      - ce.visualScore),
      heroVisual:       round2(ev.heroVisual       - ce.heroVisual),
      ctaVisual:        round2(ev.ctaVisual        - ce.ctaVisual),
      layoutVisual:     round2(ev.layoutVisual     - ce.layoutVisual),
      responsiveVisual: round2(ev.responsiveVisual - ce.responsiveVisual),
    },
    lighthouse: {
