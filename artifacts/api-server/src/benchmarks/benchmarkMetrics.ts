    ...
    for (let i = 0; i < 20; i++) {
      ...
      results.push({
        ...
        evaluatorScores: {
          ...
          visualScore:      j((seed.hero + seed.layout + seed.cta) / 3),
          heroVisual:       j(seed.hero),
          ctaVisual:        j(seed.cta),
          layoutVisual:     j(seed.layout),
          responsiveVisual: j((seed.layout + seed.consistency) / 2),
        },
        lighthouseScores: {
