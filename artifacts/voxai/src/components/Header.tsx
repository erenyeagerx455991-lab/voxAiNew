...
export default function Header({ onMenuClick, title, onPreview, hasCode, showPreview }: HeaderProps) {
  return (
    <header className="fixed top-0 left-0 right-0 z-30 bg-white/80 dark:bg-gray-900/80 md:bg-[#111118]/95 backdrop-blur-xl border-b border-gray-100 dark:border-gray-800 md:border-white/8">
