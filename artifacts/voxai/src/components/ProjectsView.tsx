...
export default function ProjectsView({ chats, onOpenProject, onCreateProject, onDeleteChat, onRenameChat }: ProjectsViewProps) {
  ...
  return (
    <div className="flex-1 overflow-y-auto px-4 pt-5 pb-8 bg-white dark:bg-gray-900">
            ...
            <div key={chat.id} className="relative group">
              ...
              <div className="absolute top-2 right-2">
                <button
                  ...
                  className="w-7 h-7 rounded-lg bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border border-gray-200 dark:border-gray-700 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity hover:bg-white dark:hover:bg-gray-900"
                >
